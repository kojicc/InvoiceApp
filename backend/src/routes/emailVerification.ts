...
import { verifyEmailToken, completeEmailVerification } from "../services/emailVerification";
...
router.post("/resend-verification", async (req: Request, res: Response) => {
  try {
    ...
    const { generateVerificationToken, sendClientVerificationEmail } = await import("../services/emailVerification");
    ...
    await sendClientVerificationEmail(user.email, user.client?.name || user.username, verificationToken);
